...
public class ReportStaffSalaryController implements Initializable {
    ...
    private void loadStaffSalaryData(int year, String monthName) {
        ...
        try {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                data.add(new StaffSalaryTM(staffSalaryDTO.getPaymentCode(), staffSalaryDTO.getStaffId(), staffDTO.getName(), staffDTO.getJob(), staffSalaryDTO.getSalary(), staffSalaryDTO.getMonth(), staffSalaryDTO.getDate()));
            }

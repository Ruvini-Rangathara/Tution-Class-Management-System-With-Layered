...
public class HallReservationDTO implements SuperDTO{
    ...
    public HallReservationDTO() {
    }

    public HallReservationDTO(String hallReservationNo, String hallNo, String classCode, String day, String startTime, String endTime) {

...
public class ExtraClassDTO implements SuperDTO {
    ...
    public ExtraClassDTO(String eClassCode, String classCode, String date, String startTime, String endTime, String hallNo) {
